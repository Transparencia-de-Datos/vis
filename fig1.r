...
fig + theme_classic() + labs(title="Distribución de la totalidad diputados por partido", subtitle ="Legislaturas LXIII,LXIV y LXV", caption = "Fuente: Currícula de la Cámara de Diputados") +
