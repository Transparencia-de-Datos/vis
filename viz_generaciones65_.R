...
viz1 + theme_classic() + labs(title="Distribución generacional de los diputados por tipo de elección", subtitle ="Legislaturas LXIV", caption = "Fuente: Currícula de la Cámara de Diputados") +
